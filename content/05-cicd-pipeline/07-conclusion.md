...
In the next lab, you will learn about container orchestration and how to deploy your container using Kubernetes to run a tightly-coupled simulation workflow.
