---
title: "a. Install the model"
weight: 10
tags: ["tutorial", "cloud9", "ParallelCluster"]
---


1. To get started, we're first going to clone the [llama-recipes](https://github.com/facebookresearch/llama-recipes) repository.
...
2. Next create a docker file for Llama 2 with the following contents:
    ...
    # Install Llama2
    #####################
    RUN cd /workspace && git clone https://github.com/facebookresearch/llama-recipes \
        && cd llama-recipes \
...
4. Convert the model to a rootless container with `enroot`:

    ```bash
    enroot import -o llama2.sqsh  dockerd://llama2:latest
    ```